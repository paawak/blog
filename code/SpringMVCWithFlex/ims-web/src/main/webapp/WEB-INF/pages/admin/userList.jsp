...
<display:table name="userList" cellspacing="0" cellpadding="0" requestURI="" 
    ...
    <display:column property="address.email" sortable="true" titleKey="user.email" style="width: 25%" autolink="true" media="html"/>
    <display:column property="address.email" titleKey="user.email" media="csv xml excel pdf"/>
