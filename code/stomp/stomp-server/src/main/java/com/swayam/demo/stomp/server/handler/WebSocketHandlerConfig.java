	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		registry.addHandler(
				new ExceptionWebSocketHandlerDecorator(
						new BankDetailsWebSocketHandler(bankDetailService, RequestType.GZIP)),
				"/streaming-bank-details").setAllowedOrigins("*");
		registry.addHandler(
				new ExceptionWebSocketHandlerDecorator(
						new BankDetailsWebSocketHandler(bankDetailService, RequestType.PLAIN_TEXT)),
				"/streaming-bank-details-plain").setAllowedOrigins("*");
	}
