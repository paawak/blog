package com.swayam.demo.stomp.server.controllers;
...
public class PageController {
	...
	@RequestMapping(path = { "/", "/index.jsp", "/welcome.jsp", "/index.html", "welcome.html" }, method = {
	...
	@RequestMapping(path = { "/stomp" }, method = { RequestMethod.GET, RequestMethod.POST })
	public ModelAndView handleStompClient() {
		return new ModelAndView("stompclient");
	}
