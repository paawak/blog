...
public class JaxbUnmarshallerTest {
	...
	// when
	LineItemRow lineItem = jaxbUnmarshaller.unmarshall(JaxbUnmarshallerTest.class.getResourceAsStream("/datasets/xml/www.cs.washington.edu/single-lineitem-row-sample.xml"), LineItemRowImpl.class);
