...
public class LargeTextComboFrameWithDefaultRenderer2 extends JFrame {
    ...
    public LargeTextComboFrameWithDefaultRenderer2() {
	init();
    }

    private void init() {
	getContentPane().setLayout(new BorderLayout());
	JLabel title = new JLabel("Large Text Combo Demo: Default ComboBox Renderer, With Max and Preferred Size Hints", JLabel.CENTER);
	...
	try {
		...
		@Override
		public void run() {
		    LargeTextComboFrameWithDefaultRenderer2 frame = new LargeTextComboFrameWithDefaultRenderer2();
