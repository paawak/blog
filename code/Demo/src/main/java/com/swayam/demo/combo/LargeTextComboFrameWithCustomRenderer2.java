...
public class LargeTextComboFrameWithCustomRenderer2 extends JFrame {
    ...
    public LargeTextComboFrameWithCustomRenderer2() {
	init();
    }

    private void init() {
	getContentPane().setLayout(new BorderLayout());
	JLabel title = new JLabel("Large Text Combo Demo: Custom ComboBox Renderer 2, With Max and Preferred Size Hints", JLabel.CENTER);
	...
	largeComboBox.setRenderer(new LargeComboBoxRenderer2(200));
	...
	try {
		...
		@Override
		public void run() {
		    LargeTextComboFrameWithCustomRenderer2 frame = new LargeTextComboFrameWithCustomRenderer2();
