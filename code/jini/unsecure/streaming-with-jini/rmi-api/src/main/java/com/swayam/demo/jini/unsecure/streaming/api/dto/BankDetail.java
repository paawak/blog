package com.swayam.demo.jini.unsecure.streaming.api.dto;
...
public class BankDetail implements Serializable {
    ...
    public String toString() {
        return "BankDetail [id=" + id + ", age=" + age + ", job=" + job + ", marital=" + marital + ", education=" + education + ", defaulted=" + defaulted + ", balance=" + balance
